...
<div class="row-fluid">
	...
	<div class="span9">
		...
		<p>The core of the web server is only 145 source lines of code and supports mapping file extensions to content types, a custom 404 page with a plaintext fallback in the case of error, and caching of web resources, with the ability to ignore caching for certain file extensions. Custom handlers can be written for specific file extensions, with the default/fallback handler simply routing the file data to the client.</p>
